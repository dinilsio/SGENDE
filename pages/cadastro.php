        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="tab-pane active" id="login">
                    ...
                    <form class="form-signin" action="" method="">
                      <input type="text" class="form-control" placeholder="Nome de usuario" required autofocus>
            ...
            <div class="tab-pane" id="register">
              <form class="form-signin" action="" method="">
                <input type="text" class="form-control" placeholder="Nome de Usuario ..." required autofocus>
                <input type="email" class="form-control" placeholder="Endereco de Email ..." required>
                <input type="password" class="form-control" placeholder="Senha de usuario..." required>
                <input type="submit" class="btn btn-lg btn-default btn-block" value="registrar" />
              </form>
              <div id="tabs" data-tabs="tabs">
